...
test("league-scoped dates survive reload routes and unknown competition codes fall back to all", () => {
  assert.deepEqual(readScoreRoute(scoreRouteHash({ date: "2026-09-10", liveOnly: true, competition: "CL" })), { tab: "live", phase: null, round: null, followingOnly: false, date: "2026-09-10", liveOnly: true, competition: "CL" });
